      ...
      <div className={`flex flex-col md:flex-row ${isOpen ? "md:gap-0" : ""}`}>
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="rounded-2xl border border-border bg-surface p-6 shadow-sm sm:p-8">
            <h1 className="text-2xl font-bold text-foreground sm:text-3xl">Profile Page</h1>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              <div className="rounded-xl border border-border bg-surface-muted p-4">
                ...
                <p className="mt-1 text-sm text-muted">Explore planos e recursos disponíveis.</p>
              </div>
              <div className="rounded-xl border border-border bg-surface-muted p-4">
                <h2 className="font-semibold">Market</h2>
                <p className="mt-1 text-sm text-muted">Veja os projetos e itens públicos.</p>
              </div>
              <div className="rounded-xl border border-border bg-surface-muted p-4">
                <h2 className="font-semibold">Contato</h2>
                <p className="mt-1 text-sm text-muted">Fale com a equipe e tire dúvidas.</p>
              </div>
            </div>
          </div>
        </main>
